...
@implementation MTGhostMenuHpPlusButtonNode
-(id) init {
    if ((self = [super initWithImageNamed:@"heartPlus.png"]))
    {
        self.name = @"MTGhostMenuHpPlusButtonNode";
    }
    return self;
}
