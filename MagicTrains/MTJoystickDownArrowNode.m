...
@implementation MTJoystickDownArrowNode
-(id) init {
    if ((self = [super initWithImageNamed:@"joystickDown.png"]))
    {
        self.name = @"MTJoysitckDownArrowNode";
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName: N_JoystickDownArrowPush object:self];
}
